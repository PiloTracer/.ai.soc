...
| SOC-011 | Strix scanning-level improvements: finish-scan reliability synthesis + per-scan-mode vulnerability-class checklist + verification first-class (`verified`/`verification_evidence` fields + `--exclude-unverified` CLI flag) — verified 2026-07-27 | DONE (uncommitted) |
