...
description: "Guide .ai.soc with custom testing instructions"
---
...
```bash
soc --target https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
soc --target https://app.com --instruction-file ./pentest-instructions.md
```
...
```bash
soc --target https://api.example.com \
...
<Tip>
Be specific. Good instructions help .ai.soc prioritize the most valuable attack paths.
</Tip>
