...
.ai.soc agents come equipped with a comprehensive toolkit:
...
.ai.soc uses a graph of specialized agents for comprehensive security testing:
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub" icon="github" href="<your-repo>">
