...
---
title: "Contributing"
description: "Contribute to .ai.soc development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `soc/skills/`
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="<your-repo>/issues">
