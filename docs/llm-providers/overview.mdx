...
---
title: "Overview"
description: "Configure your AI model for .ai.soc"
---

.ai.soc uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
