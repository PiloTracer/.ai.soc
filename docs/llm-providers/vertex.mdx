...
description: "Configure .ai.soc with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install .ai.soc with the vertex extra:

```bash
pipx install "soc[vertex]"
```
